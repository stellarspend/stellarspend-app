  ...
  const onSubmit = async (data: GoalFormData) => {
    if (!isOnline) {
      ...
      toast({
        title: "Goal Queued",
        description:
          "Offline: Your goal has been queued and will be saved when you reconnect.",
      });
      reset();
      onOpenChange(false);
      return;
    ...
    if (!publicKey) {
      toast({
        ...
        description:
          "Please connect your Freighter wallet to persist this savings goal on-chain.",
        variant: "destructive",
      });
      return;
    }
        ...
        <form
          onSubmit={(
            handleSubmit as unknown as (
              handler: (data: GoalFormData) => Promise<void>,
            ) => React.FormEventHandler<HTMLFormElement>
          )((data: GoalFormData) => onSubmit(data))}
          className="space-y-4"
        >
